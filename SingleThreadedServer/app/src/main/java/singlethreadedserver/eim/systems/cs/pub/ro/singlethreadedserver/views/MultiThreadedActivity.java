package singlethreadedserver.eim.systems.cs.pub.ro.singlethreadedserver.views;
...
import singlethreadedserver.eim.systems.cs.pub.ro.singlethreadedserver.R;
import singlethreadedserver.eim.systems.cs.pub.ro.singlethreadedserver.general.Constants;
import singlethreadedserver.eim.systems.cs.pub.ro.singlethreadedserver.network.ServerThread;

public class MultiThreadedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multi_threaded);
